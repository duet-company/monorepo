        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                href="/signup"
                className="bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white px-4 py-2 rounded-lg hover:opacity-90 transition"
              >
                Get Started
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-400 mb-8 max-w-2xl mx-auto">
              Autonomous AI agents design, deploy, and manage scalable data platforms. 90% less
              cost, 100x faster queries, minimal human oversight.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/signup"
                className="w-full sm:w-auto bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:opacity-90 transition shadow-lg shadow-violet-500/25"
              >
                Start Free Trial
              </Link>
              <Link
                href="/demo"
                className="w-full sm:w-auto bg-slate-800 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-slate-700 transition border border-slate-700"
              >
                Watch Demo
              </Link>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-300">
                    Query executed in 0.3s · 1.2M rows analyzed
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-900/50 backdrop-blur border border-slate-800 rounded-2xl p-8 hover:border-violet-500/50 transition">
              ...
              <p className="text-slate-400">
                Ask questions in plain English. Our AI converts them to optimized SQL queries
                instantly.
              </p>
            </div>
            ...
            <div className="bg-slate-900/50 backdrop-blur border border-slate-800 rounded-2xl p-8 hover:border-violet-500/50 transition">
              ...
              <p className="text-slate-400">
                Describe your needs. Our AI designs schemas, provisions infrastructure, and sets up
                dashboards.
              </p>
            </div>
            ...
            <div className="bg-slate-900/50 backdrop-blur border border-slate-800 rounded-2xl p-8 hover:border-violet-500/50 transition">
              ...
              <p className="text-slate-400">
                ClickHouse-powered analytics with sub-second response times on billions of rows.
              </p>
            </div>
            ...
            <div className="bg-slate-900/50 backdrop-blur border border-slate-800 rounded-2xl p-8 hover:border-violet-500/50 transition">
              ...
              <p className="text-slate-400">
                SOC 2 compliant, end-to-end encryption, role-based access control built-in.
              </p>
            </div>
            ...
            <div className="bg-slate-900/50 backdrop-blur border border-slate-800 rounded-2xl p-8 hover:border-violet-500/50 transition">
              ...
              <p className="text-slate-400">
                AI monitors and optimizes your platform 24/7, fixing issues before they impact you.
              </p>
            </div>
            ...
            <div className="bg-slate-900/50 backdrop-blur border border-slate-800 rounded-2xl p-8 hover:border-violet-500/50 transition">
              ...
              <p className="text-slate-400">
                Better compression, optimized queries, and efficient infrastructure = huge savings.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative">
              ...
              <p className="text-slate-400">
                Tell our AI what data you have and what questions you want to answer. Natural
            ...
            <div className="relative">
              ...
              <p className="text-slate-400">
                Our AI designs the schema, provisions ClickHouse, and sets up optimized dashboards
                automatically.
              </p>
              <div className="mt-6 bg-slate-800/50 rounded-lg p-4 border border-slate-700">
            ...
            <div className="relative">
              ...
              <p className="text-slate-400">
                Ask questions in plain English and get instant answers. Dashboards update in
                real-time.
              </p>
              <div className="mt-6 bg-slate-800/50 rounded-lg p-4 border border-slate-700">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-slate-900/50 backdrop-blur border border-slate-800 rounded-2xl p-8">
              ...
              <Link
                ...
                className="block w-full bg-slate-800 text-white text-center py-3 rounded-xl hover:bg-slate-700 transition border border-slate-700"
              >
                Get Started
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-b from-violet-900/50 to-fuchsia-900/50 backdrop-blur border border-violet-500/50 rounded-2xl p-8 relative">
              ...
              <Link
                ...
                className="block w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white text-center py-3 rounded-xl hover:opacity-90 transition"
              >
                Get Started
              </Link>
            </div>
