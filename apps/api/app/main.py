"""
Duet Company - Main API Application
...
async def startup_event():
    ...
    logger.info("Starting Duet Company API...")
...
async def shutdown_event():
    """Cleanup on shutdown."""
    logger.info("Shutting down Duet Company API...")
...
async def root():
    """Root endpoint."""
    return {
        "message": "Duet Company - AI-First Data Infrastructure",
        "version": "0.1.0",
        "docs": "/api/docs",
        "health": "/health"
    }
